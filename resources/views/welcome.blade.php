    ...
    <style>
        * {
        ...
        .logo {
            font-size: 60px;
            font-weight: 700;
            /* Original gradient with pink added */
            background: linear-gradient(90deg, rgba(220, 38, 38, 1) 60%, rgba(225, 29, 78, 1) 100%);
        ...
        .btn-yes {
            /* Original radial gradient with pink mix */
            background: radial-gradient(circle, rgba(255, 71, 71, 1) 40%, rgba(225, 38, 78, 1) 100%);
            color: white;
            border: 2px solid transparent;
            background: 
                radial-gradient(circle, rgba(255, 71, 71, 1) 40%, rgba(225, 38, 78, 1) 100%) padding-box,
                radial-gradient(circle, rgba(255, 71, 71, 1) 40%, rgba(225, 38, 78, 1) 100%) border-box;
        }
        ...
        .btn-yes:hover {
            ...
            border: 2px solid transparent;
            background: 
                radial-gradient(circle, rgba(255, 71, 71, 1) 40%, rgba(210, 34, 70, 1) 100%) padding-box,
                radial-gradient(circle, rgba(255, 71, 71, 1) 40%, rgba(210, 34, 70, 1) 100%) border-box;
        ...
        .btn-no {
            ...
            border: 2px solid #dc2626; /* Original red */
        }
        ...
        .welcome-bg img {
            ...
            height: auto;
            border-radius: 20px;
            filter: drop-shadow(0 20px 50px rgba(225, 38, 78, 0.15));
        }
